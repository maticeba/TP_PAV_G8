...
namespace ComunicAr.Formularios.Transaccion.Detalle_Dispositivos
{
    ...
    public partial class Frm_Detalle_VtaDispo : Form
    {
        ...
        private void Frm_Detalle_Venta_Dispositivos_Load(object sender, EventArgs e)
        {
            flag = false;
            Pp_descuento = 0;
            ...
            Detalle_Servicio_Prepago detalle_v = new Detalle_Servicio_Prepago();
        ...
        private void CargarDatos(DataTable tabla)
        {
            ...
            for (int i = 0; i < tabla.Rows.Count; i++)
            {
                ...
                dataGridView_DetVtaDisp.Rows[i].Cells[0].Value = tabla.Rows[i]["IdVenta"].ToString();
                dataGridView_DetVtaDisp.Rows[i].Cells[1].Value = tabla.Rows[i]["FechaVenta"].ToString();
        ...
        {
            Pp_venta_dispositivo = dataGridView_DetVtaDisp.CurrentRow.Index.ToString();
            flag = true;
            numero_fila = int.Parse(dataGridView_DetVtaDisp.CurrentRow.Index.ToString());
        }
