...
namespace ComunicAr.Formularios.Transaccion.Frm_Detalle_Servicios_Datos
 
{
    public partial class Frm_Detalle_Servicios_Datos : Form
    {
        ...
        private void Detalle_Servicios_Datos_Load(object sender, EventArgs e)
        {
            ...
            Detalle_Servicios_Datos detalle_c = new Detalle_Servicios_Datos();
            ...
            Detalle_Servicios_Datos detalle = new Detalle_Servicios_Datos();
